  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Management System: Empowering Employees, Streamlining Payrolls, and Enhancing Performance Evaluations. A comprehensive solution for managing employee data, vacations, time tracking, and more, all in one central place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Management System: Empowering Employees, Streamlining Payrolls, and Enhancing Performance Evaluations. A comprehensive solution for managing employee data, vacations, time tracking, and more, all in one central place.`}
            </Text>
            <Box

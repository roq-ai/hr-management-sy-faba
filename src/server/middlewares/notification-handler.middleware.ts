...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Payroll Officer.create': { roles: ['owner', 'hr-manager'], key: 'payroll', tenantPath: [], userPath: [] },
  'Employee.update': { roles: ['owner', 'hr-manager'], key: 'employee', tenantPath: [], userPath: [] },
  'HR Manager.create': { roles: ['owner', 'payroll-officer', 'employee'], key: 'job', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['owner', 'hr-manager', 'payroll-officer', 'employee'];
